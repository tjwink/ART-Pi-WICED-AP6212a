...
static void* wwd_handle_apsta_event( const wwd_event_header_t* event_header, const uint8_t* event_data, /*@returned@*/ void* handler_user_data )
{
    ...
    {
        wwd_result_t result;
        result = WWD_SUCCESS;//host_rtos_set_semaphore( &wwd_wifi_sleep_flag, WICED_FALSE );
...
wwd_management_set_event_handler( apsta_events, wwd_handle_apsta_event, NULL, WWD_AP_INTERFACE );
