...
#define IP_ADDR             MAKE_IPV4_ADDRESS( 192, 168, 1,  188 )
...
#define MAX_PAYLOAD         (100) /* bytes */
#define PAYLOAD             "BCM43362WIFI裸机驱动程序，无系统，无协议栈，直接UDP发送数据!"
...
static wiced_mac_t   my_mac             = { {0x12,0x34,0x56,0x78,0x11,0x22} };
...
int main( void )
{
    ...
    while ( 1 )
    {
        ...
        WPRINT_APP_INFO(("Sending "PAYLOAD"\n"));
