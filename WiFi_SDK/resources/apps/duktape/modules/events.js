...
var logger = new Duktape.Logger('events');
...
EventEmitter.prototype.addListener = function addListener(type, listener) {
  if (typeof listener !== 'function') {
    logger.error("addListener: listener is not a function", listener)
...
EventEmitter.prototype.once = function once(type, listener) {
  if (typeof listener !== 'function') {
    logger.error("once: listener is not a function", listener)
    throw new TypeError('listener must be a function');
  }
...
EventEmitter.prototype.removeListener =
  ...
  if (typeof listener == 'undefined' || typeof listener !== 'function') {
    logger.error("removListener: listener is not a function", listener)
    return this;
  }
...
EventEmitter.prototype.removeAllListeners =
  ...
  if (arguments.length === 0) {
    for (key in this._events) {
      if (key === 'removeListener' || !this._events.hasOwnProperty(key))
        continue;
