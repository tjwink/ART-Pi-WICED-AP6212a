...
static const wiced_button_configuration_t button_configurations[] =
{
    ...
    [ PLAY_PAUSE_BUTTON     ]     = { PLATFORM_BUTTON_4, BUTTON_CLICK_EVENT | BUTTON_SHORT_DURATION_EVENT | BUTTON_LONG_DURATION_EVENT | BUTTON_VERY_LONG_DURATION_EVENT, 0 },
#endif
...
static void app_button_event_handler( const button_manager_button_t* button, button_manager_event_t event, button_manager_button_state_t state )
{
    ...
    {
        case BUTTON_EVENT_ID( PLAY_PAUSE_BUTTON, BUTTON_LONG_DURATION_EVENT,      BUTTON_STATE_RELEASED ): new_action = ACTION_MULTI_FUNCTION_SHORT_RELEASE; break;

        case BUTTON_EVENT_ID( PLAY_PAUSE_BUTTON, BUTTON_VERY_LONG_DURATION_EVENT, BUTTON_STATE_RELEASED ): new_action = ACTION_MULTI_FUNCTION_LONG_RELEASE; break;
