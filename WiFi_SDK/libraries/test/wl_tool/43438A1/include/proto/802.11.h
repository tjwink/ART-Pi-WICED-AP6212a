 ...
 *
 * $Id: 802.11.h 491393 2014-07-16 07:00:48Z kakrishn $
 */
...
#ifdef WL_FTM
/* give extcap some room for FTM */
#define DOT11_EXTCAP_LEN_MAX 12
#else
...
#define DOT11_MNG_FTM_PARAMS_ID         200 /* XXX mcd2.6/2014 this is not final yet */
...
/* add ext cap bits above and check/update DOT11_EXTCAP_LEN_MAX below */
...
#define FTM_PARAMS_STATUS_MASK 0x07
...
#define FTM_PARAMS_VALUE_MASK 0xf8
#define FTM_PARAMS_VALUE_SHIFT 3
...
#define FTM_PARAMS_SET_BURSTTMO(_p, _tmo) FTM_PARAMS_SET_FIELD(_p, \
    FTM_PARAMS_BURSTTMO_OFFSET, FTM_PARAMS_BURSTTMO_MASK, FTM_PARAMS_BURSTTMO_SHIFT, _tmo)

#define FTM_PARAMS_BURSTTMO_USEC(_val) ((1 << (_val)) * 250)
#define FTM_PARAMS_BURSTTMO_VALID(_val) ((_val) < 10 || (_val) == FTM_PARAMS_BURSTTMO_NOPREF)
...
#define FTM_PARAMS_ASAP_MASK 0x1
#define FTM_PARAMS_ASAP_SHIFT 0
...
enum {
    ...
    FTM_PARAMS_STATUS_OVERRIDDEN = 2,
    FTM_PARAMS_STATUS_INCAPABLE = 3,
    FTM_PARAMS_STATUS_FAILED = 4,
    /* 0 and rest are reserved */
};

enum {
    FTM_PARAMS_CHAN_INFO_NO_PREF        = 0,
    FTM_PARAMS_CHAN_INFO_NON_HT_5       = 1,
    FTM_PARAMS_CHAN_INFO_NON_HT_10      = 2,
    FTM_PARAMS_CHAN_INFO_NON_HT_20      = 3, /* excludes 2.4G, and High rate DSSS */
    FTM_PARAMS_CHAN_INFO_HT_MF_20       = 4,
    FTM_PARAMS_CHAN_INFO_VHT_20         = 5,
    FTM_PARAMS_CHAN_INFO_HT_MF_40       = 6,
    FTM_PARAMS_CHAN_INFO_VHT_40         = 7,
    FTM_PARAMS_CHAN_INFO_VHT_80         = 8,
    FTM_PARAMS_CHAN_INFO_VHT_80_80      = 9,
    FTM_PARAMS_CHAN_INFO_VHT_160        = 10,
    FTM_PARAMS_CHAN_INFO_DMG_2160       = 11,
    FTM_PARAMS_CHAN_INFO_MAX
};
