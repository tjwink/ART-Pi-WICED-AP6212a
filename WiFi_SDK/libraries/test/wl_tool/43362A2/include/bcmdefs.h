 ...
 *
 * $Id: bcmdefs.h,v 13.68.2.8 2011-01-08 04:04:19 chandrr Exp $
 */
...
#elif defined(BCMROMBUILD) && !defined(BCMROMSYMGEN_BUILD)
#include <bcmjmptbl.h>
#define STATIC	static
#else /* !BCMROMBUILD */
#define BCMROMDATA(_data)	_data
