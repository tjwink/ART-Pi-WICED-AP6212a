 ...
 *
 * $Id: bcmutils.h 376927 2013-01-03 09:34:52Z sushant $
 */
...
/* variable access */
	...
	!defined(BCMINTERNAL) && !defined(BCMDBG_DUMP)
#ifdef BCMDBG
...
#endif /* BCMDBG */
#else /* DONGLEBUILD && WLC_HIGH && !WLTEST && !BCMINTERNAL && !BCMDBG_DUMP */
#define NVRAM_RECLAIM_CHECK(name)
#endif /* DONGLEBUILD && WLC_HIGH && !WLTEST && !BCMINTERNAL && !BCMDBG_DUMP */
...
/* 16-bit checksum */
extern uint16 checksum_ipv4(void *dataptr, uint16 len);
/* format/print */
