 ...
 *
 * $Id: bcmdefs.h 361679 2012-10-09 17:41:17Z nvalji $
 */
...
#define SRMATTACHDATA(_data)	__attribute__ ((__section__ (".datasrm." #_data))) _data
#define SRMATTACHFN(_fn)	__attribute__ ((__section__ (".textsrm." #_fn), noinline)) _fn
...
#define BCM_NO_INLINE(_fn) __attribute__ ((noinline)) _fn
...
#define BCMROMBASE ((uint32) 0x800000)
