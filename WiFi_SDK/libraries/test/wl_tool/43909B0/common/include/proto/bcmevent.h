 ...
 *
 * $Id: bcmevent.h 472396 2014-04-23 23:39:20Z xiaodant $
 *
 */
...
#define WLC_E_EVENT_100			100	/* XXX Reserved event, see johnvb/jsiegel */
...
/* XXX: do not change WLC_E_LAST w/out review with 'wlan-wl-interface-list@broadcom.com' */
#define WLC_E_LAST			128	/* highest val + 1 for range checking */

/* XXX: for now event bits must fit inside 16B buffer */
#if (WLC_E_LAST > 128)
