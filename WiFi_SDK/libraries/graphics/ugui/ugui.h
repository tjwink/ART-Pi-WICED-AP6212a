...
typedef enum{
    ...
    DRIVER_DRAW_CIRCLE,
    DRIVER_FILL_CIRCLE,
    DRIVER_SET_FORECOLOR,
    DRIVER_SET_BACKCOLOR,
    DRIVER_CLEAR_SCREEN,
    DRIVER_ENABLE_CURSOR,
    DRIVER_DISABLE_CURSOR,
    DRIVER_SCREEN_UPDATE,
    /**/
    NUMBER_OF_DRIVERS
}UG_DRIVER_TYPE;
#endif
...
typedef struct
{
   ...
   UG_BUS_HANDLE bus_hdl;
   UG_DRV_HANDLE drv_hdl;
} UG_GUI;
...
#define  C_LIGHT_GUGRAY                 0xD3D3D3
