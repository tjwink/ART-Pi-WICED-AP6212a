...
LIB_SRCS := \
	...
	$(LIBSRC_DIR)/unpack3.c \
	$(LIBSRC_DIR)/unpack3_open.c \
	$(LIBSRC_DIR)/unpack3_seek.c \
...
# library build
# 
$(info wavpack-full build type is $(BUILD_TYPE).)
...
$(info ************************************************************** )
$(info ==> WAVPACK-FULL: Enabling debug build.)
$(info ************************************************************** )
