...
#define WavpackDecHeaderFormat "4LS2LLLLL"
...
typedef struct {
    WavpackDecConfig config;
    WavpackDecStream stream;
...
void bs_open_read (Bitstream *bs, uchar *buffer_start, uchar *buffer_end, read_stream file, void* wv_in, uint32_t file_bytes);
...
int unpack_init (WavpackDecContext *wpc);
int init_wv_bitstream (WavpackDecContext *wpc, WavpackDecMetadata *wpmd);
int read_decorr_terms (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_decorr_weights (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_decorr_samples (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_float_info (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_int32_info (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_channel_info (WavpackDecContext *wpc, WavpackDecMetadata *wpmd);
int read_config_info (WavpackDecContext *wpc, WavpackDecMetadata *wpmd);
int32_t unpack_samples (WavpackDecContext *wpc, int32_t *buffer, uint32_t sample_count);
int check_crc_error (WavpackDecContext *wpc);
...
int read_entropy_vars_dec (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int read_hybrid_profile_dec (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
int32_t get_words_dec (int32_t *buffer, int nsamples, uint32_t flags,
                struct words_data *w, Bitstream *bs);
int32_t exp2s_dec (int log);
int restore_weight_dec (signed char weight);
...
int read_float_info (WavpackDecStream *wps, WavpackDecMetadata *wpmd);
void float_values (WavpackDecStream *wps, int32_t *values, int32_t num_values);

// wputils.c

WavpackDecContext *WavpackDecOpenFileInput (read_stream infile, void *wv_id, char *error);

int WavpackDecGetMode (WavpackDecContext *wpc);
...
uint32_t WavpackDecUnpackSamples (WavpackDecContext *wpc, int32_t *buffer, uint32_t samples);
uint32_t WavpackDecGetNumSamples (WavpackDecContext *wpc);
uint32_t WavpackDecGetSampleIndex (WavpackDecContext *wpc);
int WavpackDecGetNumErrors (WavpackDecContext *wpc);
int WavpackDecLossyBlocks (WavpackDecContext *wpc);
uint32_t WavpackDecGetSampleRate (WavpackDecContext *wpc);
int WavpackDecGetBitsPerSample (WavpackDecContext *wpc);
int WavpackDecGetBytesPerSample (WavpackDecContext *wpc);
int WavpackDecGetNumChannels (WavpackDecContext *wpc);
int WavpackDecGetReducedChannels (WavpackDecContext *wpc);
