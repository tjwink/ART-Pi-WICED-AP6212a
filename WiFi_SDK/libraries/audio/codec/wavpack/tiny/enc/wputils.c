...
static WavpackEncContext wavpack_context;
...
{
    WavpackEncContext *wpc = &wavpack_context;
...
static int finish_block (WavpackEncContext *wpc);
...
static int finish_block (WavpackEncContext *wpc)
{
    ...
    WavpackEncNativeToLittleEndian ((WavpackHeader *) wps->blockbuff, WavpackHeaderFormat);
    ...
    if (wps->block2buff) {
        ...
        WavpackEncNativeToLittleEndian ((WavpackHeader *) wps->block2buff, WavpackHeaderFormat);
...
{
    WavpackEncLittleEndianToNative (first_block, WavpackHeaderFormat);
    ((WavpackHeader *) first_block)->total_samples = WavpackEncGetSampleIndex (wpc);
    WavpackEncNativeToLittleEndian (first_block, WavpackHeaderFormat);
}

// return TRUE if any uncorrected lossy blocks were actually written or read

int WavpackencLossyBlocks (WavpackEncContext *wpc)
{
