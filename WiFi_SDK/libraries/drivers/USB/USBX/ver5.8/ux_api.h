...
{                                        
    ...
    ULONG           ux_system_host_thread_stack_size;   /* #WICED#: Add for user configurable purpose */
} UX_SYSTEM_HOST;
...
{                                        
    ...
    ULONG           ux_system_slave_thread_stack_size;   /* #WICED#: Add for user configurable purpose */
} UX_SYSTEM_SLAVE;
...
/*
 * #WICED#: Add UX_USER_CONFIG_HOST & UX_USER_CONFIG_DEVICE for several parameters used in
 * _ux_host_stack_initialize() & _ux_device_stack_initialize() those had better to open for application layer config.
...
/* Define USBX User Config Device Data structure.  */
typedef struct UX_USER_CONFIG_DEVICE_STRUCT
{
    UINT            ux_user_config_device_max_class;
    ULONG           ux_user_config_device_thread_stack_size;
} UX_USER_CONFIG_DEVICE;
...
UINT    ux_host_stack_initialize(UINT (*ux_system_host_change_function)(ULONG, UX_HOST_CLASS *, VOID *), UX_USER_CONFIG_HOST *user_config_host);   /* #WICED#: Add argument to get user config from application. */
...
/* #WICED#: Include WICED include file.  */
#include "wiced.h"
