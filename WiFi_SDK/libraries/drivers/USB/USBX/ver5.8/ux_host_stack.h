...
UINT    _ux_host_stack_initialize(UINT (*ux_system_host_change_function)(ULONG, UX_HOST_CLASS *, VOID *), UX_USER_CONFIG_HOST *user_config_host);   /* #WICED#: Add argument to get user config from application. */
