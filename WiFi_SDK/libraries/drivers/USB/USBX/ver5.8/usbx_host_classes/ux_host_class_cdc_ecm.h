...
/*                                                                        */ 
/*  06-01-2017     TCRG                     Initial Version 5.8           */ 
/*                                                                        */ 
/**************************************************************************/ 
...
#define UX_HOST_CLASS_CDC_ECM_NX_BUFF_SIZE                     (UX_HOST_CLASS_CDC_ECM_ETHERNET_PACKET_SIZE + sizeof(NX_PACKET) + UX_HOST_CLASS_CDC_ECM_NX_ALIGN_PADDING)
...
/* Define  CDC_ECM Reception States. */

#define UX_HOST_CLASS_CDC_ECM_RECEPTION_STATE_STOPPED          0
#define UX_HOST_CLASS_CDC_ECM_RECEPTION_STATE_STARTED          1
#define UX_HOST_CLASS_CDC_ECM_RECEPTION_STATE_IN_TRANSFER      2
...
typedef struct UX_HOST_CLASS_CDC_ECM_STRUCT
{
    ...
    TX_SEMAPHORE    ux_host_class_cdc_ecm_semaphore;
    ...
    NX_PACKET       *ux_host_class_cdc_ecm_xmit_queue;
    NX_PACKET       *ux_host_class_cdc_ecm_receive_queue;
    NX_PACKET_POOL  ux_host_class_cdc_ecm_packet_pool;
    UCHAR           *ux_host_class_cdc_ecm_pool_memory;
    UCHAR           ux_host_class_cdc_ecm_node_id[16];
...
/* Define  CDC_ECM reception structure. */

typedef struct UX_HOST_CLASS_CDC_ECM_RECEPTION_STRUCT
{

    ULONG           ux_host_class_cdc_ecm_reception_state;
    ULONG           ux_host_class_cdc_ecm_reception_block_size;
    UCHAR           *ux_host_class_cdc_ecm_reception_data_buffer;
    ULONG           ux_host_class_cdc_ecm_reception_data_buffer_size;
    UCHAR           *ux_host_class_cdc_ecm_reception_data_head;
    UCHAR           *ux_host_class_cdc_ecm_reception_data_tail;
    VOID            (*ux_host_class_cdc_ecm_reception_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm, 
                                                                UINT  status,
                                                                UCHAR *reception_buffer, 
                                                                ULONG reception_size);

} UX_HOST_CLASS_CDC_ECM_RECEPTION;
...
UINT  _ux_host_class_cdc_ecm_configure(UX_HOST_CLASS_CDC_ECM *cdc_ecm);
UINT  _ux_host_class_cdc_ecm_deactivate(UX_HOST_CLASS_COMMAND *command);
VOID  _ux_host_class_cdc_ecm_driver_entry(NX_IP_DRIVER *nx_ip_driver);
...
UINT  _ux_host_class_cdc_ecm_read (UX_HOST_CLASS_CDC_ECM *cdc_ecm, UCHAR *data_pointer, 
                                  ULONG requested_length, ULONG *actual_length);
UINT  _ux_host_class_cdc_ecm_write(VOID *cdc_ecm_class, NX_PACKET *packet);
VOID  _ux_host_class_cdc_ecm_transfer_request_completed(UX_TRANSFER *transfer_request);
UINT  _ux_host_class_cdc_ecm_reception_stop (UX_HOST_CLASS_CDC_ECM *cdc_ecm, 
                                    UX_HOST_CLASS_CDC_ECM_RECEPTION *cdc_ecm_reception);
UINT  _ux_host_class_cdc_ecm_reception_start (UX_HOST_CLASS_CDC_ECM *cdc_ecm, 
                                    UX_HOST_CLASS_CDC_ECM_RECEPTION *cdc_ecm_reception);
VOID  _ux_host_class_cdc_ecm_interrupt_notification(UX_TRANSFER *transfer_request);
VOID  _ux_host_class_cdc_ecm_reception_callback (UX_TRANSFER *transfer_request);
...
UINT  _ux_host_class_cdc_ecm_setup(UX_HOST_CLASS_CDC_ECM *cdc_ecm);
                                    
/* Define CDC ECM Class API prototypes.  */

#define ux_host_class_cdc_ecm_entry        _ux_host_class_cdc_ecm_entry
#define ux_host_class_cdc_ecm_read         _ux_host_class_cdc_ecm_read
