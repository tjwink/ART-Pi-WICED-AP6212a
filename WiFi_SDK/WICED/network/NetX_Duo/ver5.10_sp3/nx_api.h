...
#if defined(THREADX_MAJOR_VERSION)
...
#endif /* defined(THREADX_MAJOR_VERSION) */
...
#define __NETXDUO_MINOR_VERSION__                10
...
#if defined(NX_IPSEC_ENABLE) || defined(NX_ENABLE_INTERFACE_CAPABILITY)
#define NX_PROTOCOL_IPV4                       4   /* IP-in-IP encapsulation */
#define NX_PROTOCOL_IPV6                       41  /* IP-in-IP encapsulation */
#endif /* defined(NX_IPSEC_ENABLE) || defined(NX_ENABLE_INTERFACE_CAPABILITY) */
...
#define nx_ip_additional_link_info     nx_ip_interface[0].nx_interface_additional_link_info
   ...
   /*  Define the NAT forwarded packet handler. This is by default set to NX_NULL.  */
    ...
    void        (*nx_destination_table_periodic_update)(VOID);
#endif
