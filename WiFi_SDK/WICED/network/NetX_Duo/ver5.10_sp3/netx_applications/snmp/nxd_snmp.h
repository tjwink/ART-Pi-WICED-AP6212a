...
#define NX_SNMP_ANS1_IPV6_ADDRESS           0x44                    /* ANS1 Code for OPAQUE                 */ 
#endif
...
typedef struct NX_SNMP_OBJECT_DATA_STRUCT
{
    ...
    NXD_ADDRESS     nx_snmp_nxd_address;                            /* IPv6 or IPv4 address                */
...
typedef struct NX_SNMP_AGENT_STRUCT 
{
    ...
    UCHAR           nx_snmp_agent_current_community_string[NX_SNMP_MAX_USER_NAME]; /* Received Community string            */
    UCHAR           nx_snmp_agent_private_community_string[NX_SNMP_MAX_USER_NAME]; /* Agent's private community string     */
    UCHAR           nx_snmp_agent_public_community_string[NX_SNMP_MAX_USER_NAME];  /* Agent's public community string      */  
    UCHAR           nx_snmp_agent_current_octet_string[NX_SNMP_MAX_OCTET_STRING];  /* Current SNMP Object ID*/
...
UINT    _nx_snmp_utility_sequence_set_1byte(UCHAR *buffer_ptr, UINT sequence_value);
...
UINT    _nx_snmp_utility_request_type_set_1byte(UCHAR *buffer_ptr, UINT request_type, UINT request_length);
UINT    _nx_snmp_utility_request_type_set_multibyte(UCHAR *buffer_ptr, UINT request_type, UINT request_length);
...
VOID    _nx_snmp_version_3_report_send(NX_SNMP_AGENT *agent_ptr, UCHAR *buffer_ptr, UINT discovery_response);
VOID    _nx_snmp_version_3_process(NX_SNMP_AGENT *agent_ptr, NX_PACKET *packet_ptr);
UINT    _nx_snmp_agent_encrypt_pdu(NX_SNMP_AGENT *agent_ptr, UINT *response_pdu_length, UINT *response_sequence_length, UCHAR *response_encryption_size_ptr, UCHAR **response_sequence_ptr,UCHAR **response_buffer_ptr,UCHAR *response_privacy_ptr);
...
UINT    _nx_snmp_agent_decrypt_pdu(NX_SNMP_AGENT *agent_ptr, UCHAR **buffer_ptr, UCHAR *response_buffer_ptr,  UCHAR **response_encryption_size_ptr, UINT *response_length);
