...
extern NX_IPV6_DESTINATION_ENTRY nx_destination_table[NX_IPV6_DESTINATION_TABLE_SIZE];
...
VOID _nx_icmpv6_destination_table_periodic_update(VOID);
#endif
...
UINT _nxd_ipv6_destination_table_find_next_hop(ULONG *destination_ip, ULONG *next_hop);
