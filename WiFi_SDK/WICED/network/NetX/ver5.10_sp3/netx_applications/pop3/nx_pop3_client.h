...
{
    CHAR                            nx_pop3_client_name[NX_POP3_MAX_USERNAME];      /* Client name (also used in authentication) */
    CHAR                            nx_pop3_client_password[NX_POP3_MAX_PASSWORD];  /* Client password for authentication */
    ...
    CHAR                            nx_pop3_server_process_id[NX_POP3_SERVER_PROCESS_ID_SIZE];
...
UINT    _nx_pop3_digest_authenticate(NX_POP3_CLIENT *client_ptr, CHAR *process_ID_ptr, CHAR *result);
