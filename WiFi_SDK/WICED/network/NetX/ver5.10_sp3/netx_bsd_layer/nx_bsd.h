...
/*                                            in version 5.10             */
/*  04-03-2017     Janet Christiansen       Modified comment(s), removed  */
/*                                            the check for NX_BSD_INHERIT*/
/*                                            _LISTENER_SOCKET_SETTINGS,  */
...
#ifndef NX_BSD_TIMED_WAIT_TIMEOUT                                            /* Currently not available in NetX BSD:                        */
#define NX_BSD_TIMED_WAIT_TIMEOUT           (60 * NX_IP_PERIODIC_RATE)       /* Timeout for sockets in the Timed Wait state (socket must     */
