#ifndef __OV5640_REG_H
#define	__OV5640_REG_H
...
/* JPG 160x120 */
const u16 OV5640_160x120_JPEG[][2]=
{
      0x3035, 0x21,  
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
    0x3820, 0x46, // flip
    0x3821, 0x20, // mirror									 
    0x3814, 0x31, // timing X inc 11
    0x3815, 0x31, // timing Y inc 11
    0x3800, 0x00, // HS 
    0x3801, 0x00, // HS 
    0x3802, 0x00, // VS 
    0x3803, 0x04, // VS   
...
/* JPG 320x240 */
const u16 OV5640_320x240_JPEG[][2]=
{
    0x3035, 0x21,  
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
...
/* JPG, 0x640x480 */
const u16 OV5640_640x480_JPEG[][2]=
{
    0x3035, 0x21,
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
...
/* JPG, 0x800x600 */
const u16 OV5640_800x600_JPEG[][2]=
{
    0x3035, 0x21,
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
...
/* JPG, 0x1024x768 */
const u16 OV5640_1024x768_JPEG[][2]=
{
    0x3035, 0x21,
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
...
/* JPEG, 0x1280x960 */
const u16 OV5640_1280x960_JPEG[][2]=
{
    0x3035, 0x21,
    0x3036, 0xac, // 22fps 0x46//15fps
    0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
...
/* JPG, 0x1600x1200 */
const u16 OV5640_1600x1200_JPEG[][2]=
{
    // Input clock = 24Mhz
    0x3035, 0x21, // PLL  
    0x3036, 0x69, // PLL 
...
/* JPEG, 2048x1536 */
const u16 OV5640_2048x1536_JPEG[][2]=
{
    // Input clock = 24Mhz
    0x3035, 0x21, // PLL  
    0x3036, 0x69, // PLL 
...
/* JPEG, 2320x1740 */
const u16 OV5640_2320x1740_JPEG[][2]=
{
    // Input clock = 24Mhz
    0x3035, 0x21, // PLL  
    0x3036, 0x69, // PLL 
...
/* JPEG, 2592x1944 */
const u16 OV5640_2592x1944_JPEG[][2]=
{
    // Input clock = 24Mhz
    0x3035, 0x21, // PLL  
    0x3036, 0x69, // PLL 
    ...
    0x5001, 0x83, // SDE on, scaling on, CMX on, AWB on 
    0x3503, 0x00, // AEC/AGC on
};

const u16 OV5640_JPEG_INIT[][2]=
{
    // 24MHz input clock, 24MHz PCLK
    0x3103, 0x11, // system clock from pad, bit[1]
    0x3008, 0x82, // software reset, bit[7]0x3008, 0x42, // software power down, bit[6]
